...
Page({
	...
	gridList:[
		...
		{name : '联系学生',icon: '../../../images/icon/phone.png'},
	...
	onLoad(options) {
		...
		console.log('石头人',l1ist.avatarUrl)
		this.setData({
			ava : l1ist.avatarUrl
		})
		// wx.getStorage({
		// 	key: 'userInfo',
		// 	success (res) {
		// 		console.log('看看这里1111111111111111111232323232323',res.data.avatarUrl)
		// 	}
		// })
